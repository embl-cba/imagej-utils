...
import static de.embl.cba.bdv.utils.boundingbox.BoundingBoxOverlay.*;
...
public class BoundingBoxVirtualSource implements BoundingBoxSource
{
			...
			final SetupAssignments setupAssignments )
	{
		 ...
		 * case) to ARGBType.
		 */
		final RealARGBColorConverter< UnsignedShortType > converter =
				RealARGBColorConverter.create( new UnsignedShortType(  ), 0, 3000 );
