...
final class AlternativePlaceHolderSource implements Source< UnsignedShortType >
{
	...
	private final BoundingBoxOverlay.BoundingBoxOverlaySource bbSource;

	public AlternativePlaceHolderSource( final String name, final BoundingBoxOverlay.BoundingBoxOverlaySource bbSource )
	{
		this.name = name;
